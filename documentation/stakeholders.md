...
* [4.7 Функція додавання/видалення учасників голосування](#4-7)
...
Користувач зможе проголосувати, ввівши особисто із розділу інтерфейсу входу.
...
Voting System - це веб-застосунок для участі в чесному, автоматизованому електронному голосуванні та керування його проведенням. Громадяни України зможуть увійти до власного облікового запису та отримати доступ до всіх відкритих голосувань, що актуальні для їх місця проживання. Користувачі також можуть переглядати статистику голосувань та побачити середні регіональні показники вподобань інших учасників.

## <p id="3">3. Характеристика ділових процесів</p>

### <p id="3-1">3.1 Призначення системи електронного голосування "Voting System ✓"</p>

Застосунок Voting System призначений для автоматизації процесу голосування. За статистичними даними електронне голосування підвищить чесність, а також дасть змогу зробити значно більший обсяг виборців.

### <p id="3-2">3.2 Взаємодія з користувачами. Вхід до системи</p>

Взаємодіяти з застосунком зможе будь-який громадянин України через веб-сторінку, авторизація в системі буде проходити за допомогою його google аккаунту. Користувачу будуть доступні поточні голосування, в залежності від його місця проживання, та резульати виборів у реальному часі. Авторизація здійснюється за допомогою Google Sign In. Google Sign-In управляє потоком OAuth 2.0 та життєвим циклом маркера, спрощуючи вашу інтеграцію з API Google. Використовуючи це API, ми можемо отримати ID, ім'я, аватарку та email.
...
Цільовою аудиторією є громадяни України, які досягли вісімнадцятирічного віку, та не позбавлені права голосування. 
...
Будь-який громадянин України використовуючи свій google аккаунт може зайти в систему і проголосувати.
...
### <p id="4-7">4.7 Функція додавання/видалення учасників голосування </p>

Адмін може додавати користувачів в загальну БД для голосування, а ткож видаляти їх.

### <p id="4-8">4.8 Функція входу </p>

Будь-який користувач може ввійти в систему за своїм google аккаунтом, чим самим він підтверджує свою особу. 
